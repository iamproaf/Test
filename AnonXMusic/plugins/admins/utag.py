...
@app.on_message(filters.command(["utag", "all", "mention"], prefixes=["/", "@", ".", "#"]) & admin_filter)
...
@app.on_message(filters.command(["cancel", "stoputag", "stopuall", "offutag", "offuall", "utagoff", "ualloff"], prefixes=["/", ".", "@", "#"]) & admin_filter)
